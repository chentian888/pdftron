...
export default {
  ...
  'POST /user/register': (req: any, res: any) => {
    res.json({
      msg: '注册成功',
      data: userInfo,
      code: 200,
  ...
  'POST /user/restPassword': (req: any, res: any) => {
    res.json({
      msg: 'ok',
      data: null,
      code: 200,
  ...
  'POST /paypal/pay/20': (req: any, res: any) => {
    res.json({
      msg: 'ok',
      data: {
  ...
  'POST /alipay/pay/21': (req: any, res: any) => {
    res.json({
      msg: '',
  ...
  'POST /common/multiUpload': (req: any, res: any) => {
    res.json({
      msg: 'ok',
      data: { fileId: '3658' },
      code: 200,
  ...
  'POST /pdf/asyncConvert': (req: any, res: any) => {
    res.json({
      msg: 'ok',
      data: null,
      code: 0,
